...
export default function TransferBox(props: TransferBoxProps) {
    const { visible, setVisible, box_id, boxMovementData, setBoxMovementData, details, setDetails } = props;
    ...
    const handleSubmitButton = async () => {
        ...
        try {
            const response = await fetch(`${desktopBaseURL}/api/box/box-movement/transfer`, {
                method: 'POST',
                headers: {
                    'Authorization': token,
            ...
            Alert.alert('Sucesso', 'Caixa transferida de localização com sucesso!');
            setBoxMovementData([
                {
                    id: data.id,
                    author: data.author,
            ...
            setDetails({
                ...
                actual_location_id: Number(locationId)
            });
            ...
            <View style={styles.container}>
                <ThemedView style={styles.cardForm} lightColor="#fff" darkColor="#18181B">
                    <View style={styles.cardHeader}>
                        <ThemedText style={styles.cardTitle}>Transferir Caixa</ThemedText>
                    ...
                    <View style={styles.cardBody}>
                        <View style={styles.inputGroup}>
                            <ThemedText style={styles.inputLabel}>Depósito de destino:</ThemedText>
                            <BasicDropdown
                        ...
                        <View style={styles.inputGroup}>
                            <ThemedText style={styles.inputLabel}>Localização de destino:</ThemedText>
                            <BasicDropdown
